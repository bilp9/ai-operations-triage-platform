...
SYNTHETIC_CASES = (
    ("voice", "A driver reported a collision at site PHX7. One person says their shoulder is hurt. Incident INC-48291 needs immediate review."),
    ...
    ("voice", "There is a fire near the loading area at location AZ14. People are moving away and emergency services have been called."),
